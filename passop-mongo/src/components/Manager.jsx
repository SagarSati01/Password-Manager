  ...
  const savePassword = async () => {
    if ( form.site.length > 1 && form.username.length > 1 && form.password.length > 1 ) {
      ...
      try{
        ...
        console.error("Error! Password not saved!")
      }
    } 
  }
                  ...
                  return (
                    <tr key={index}>
                      ...
                      <a href={item.site} target="_blank"> <span>{item.site}</span> </a>
                          <div className="cursor-pointer size-7 lordiconcopy self-end"
                      ...
                      <span>{"*".repeat(item.password.length)}</span>
                          <div className="cursor-pointer size-7 lordiconcopy self-end" onClick={() => copyText(item.password)} >
                            <lord-icon style={{
